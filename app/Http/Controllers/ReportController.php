...
public function destroy($id)
{
    ...
    public function email_report(Request $request)
    {
        ...
        try {
            ...
            ], function ($message) use ($recipient, $data, $attachmentContent, $attachmentName, $attachmentMime) {
    ...
    private function buildReportEmailAttachment(string $subject, string $body, ?string $reportHtml = null): array
    {
        ...
        try {
            ...
            Log::warning('Report PDF attachment generation failed, falling back to text attachment', [
                'error' => $e->getMessage(),
                'subject' => $subject,
            ]);
