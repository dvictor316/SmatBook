<?php $page = 'signature-preview-invoice'; ?>
            ...
            <div class="inv-content">
                ...
                <div class="bank-details">
                    ...
                    <div class="company-sign">
                        ...
                        <img src="{{ URL::asset('/assets/img/signature.png') }}" alt="signature-img">
                    </div>
                </div>
                <div class="terms-condition">
                    ...
                    <ol>
                        ...
                        <li> We are not the manufactures, company will stand for warrenty as per their terms and conditions.
                        </li>
                    </ol>
                </div>
                ...
                <div class="add-customer-btns text-end">
                    ...
                    <a href="{{ url('mail-pay-invoice') }}" class="btn btn-primary">Save & Send</a>
                </div>
            </div>
        </div>
    </div>
