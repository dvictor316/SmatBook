            ...
            <div class="col-lg-9">
                <div class="receipt-card p-5">
                    ...
                    <div class="row receipt-header mb-5 align-items-top">
                        <div class="col-sm-6">
                            <div class="receipt-logo mb-2">{{ config('app.name') }}</div>
                            <div class="company-details">
                                <p class="mb-0">{{ config('app.address') }}</p>
                                <p class="mb-0">{{ config('app.city') }}</p>
                                <p class="mb-0">Phone: {{ config('app.phone') }}</p>
                    ...
                    <div class="mt-5 pt-4 border-top">
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <p class="text-muted small">This is an automated receipt generated by {{ config('app.name') }}.</p>
                            </div>
