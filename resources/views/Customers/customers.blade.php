                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="dropdown dropdown-action">
                                                        <button type="button" class="btn btn-sm btn-primary dropdown-toggle" data-bs-toggle="dropdown" data-sheet-title="Customer actions" data-spb-native-desktop-dropdown="true" aria-expanded="false">
                                                            Action
                                                        </button>
