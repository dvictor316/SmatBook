                    ...
                    <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="opening_balance" class="form-control" value="{{ old('opening_balance', $supplier->opening_balance ?? '') }}" placeholder="0.00">
                                <small class="text-muted">Amount owed to this supplier at setup.</small>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Opening Balance Date</label>
                                <input type="date" name="opening_balance_date" class="form-control" value="{{ old('opening_balance_date', $supplier->opening_balance_date ?? '') }}">
                            </div>
                        </div>
                        <div class="text-end">
