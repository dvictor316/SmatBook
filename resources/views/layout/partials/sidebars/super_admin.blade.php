...
<style>
    ...
    body.spb-super-admin-theme .workspace-switcher {
    ...
    body.spb-super-admin-theme .workspace-switcher a {
        color: var(--spb-theme-blue) !important;
        -webkit-text-fill-color: var(--spb-theme-blue) !important;
    }

    body.spb-super-admin-theme .workspace-switcher a.is-active {
    ...
    body.spb-super-admin-theme .branch-pill {
    ...
    body.spb-super-admin-theme .branch-pill i,
    body.spb-super-admin-theme .branch-pill .branch-active-label {
        color: var(--spb-theme-blue) !important;
        -webkit-text-fill-color: var(--spb-theme-blue) !important;
    }
    ...
    body.spb-super-admin-theme .pos-full-page-wrapper .header-stage {
        background:
            radial-gradient(circle at 12% 0%, rgba(215, 169, 40, 0.20), transparent 34%),
            radial-gradient(circle at 88% 12%, rgba(37, 99, 235, 0.16), transparent 36%),
            linear-gradient(135deg, #ffffff 0%, #f7faff 48%, #edf4ff 100%) !important;
        border-color: rgba(15, 58, 138, 0.22) !important;
        box-shadow: 0 18px 36px rgba(6, 26, 68, 0.12) !important;
    }

    body.spb-super-admin-theme .pos-full-page-wrapper .header-stage::after {
        box-shadow: inset 0 0 0 1px rgba(215, 169, 40, 0.30) !important;
    }

    body.spb-super-admin-theme .pos-full-page-wrapper .pos-header-bar {
        background: #ffffff !important;
        border-color: rgba(15, 58, 138, 0.16) !important;
        box-shadow: 0 12px 26px rgba(6, 26, 68, 0.08) !important;
    }
    ...
    body.spb-super-admin-theme .pos-full-page-wrapper .header-util-note,
    body.spb-super-admin-theme .pos-full-page-wrapper .header-util-note span,
    body.spb-super-admin-theme .pos-full-page-wrapper .user-name {
        color: var(--spb-theme-ink) !important;
        -webkit-text-fill-color: var(--spb-theme-ink) !important;
    }

    body.spb-super-admin-theme .pos-full-page-wrapper .header-util-note .accent,
    body.spb-super-admin-theme .pos-full-page-wrapper .user-label,
    body.spb-super-admin-theme .pos-full-page-wrapper .scanner-label {
        color: var(--spb-theme-blue) !important;
        -webkit-text-fill-color: var(--spb-theme-blue) !important;
    }

    body.spb-super-admin-theme .pos-full-page-wrapper .util-pill {
        background: linear-gradient(135deg, var(--spb-theme-blue) 0%, var(--spb-theme-blue-bright) 100%) !important;
        border-color: rgba(215, 169, 40, 0.38) !important;
        color: #ffffff !important;
        -webkit-text-fill-color: #ffffff !important;
    ...
    body.spb-super-admin-theme .pos-full-page-wrapper .clock-badge {
        background: linear-gradient(135deg, #fff3c4 0%, var(--spb-theme-gold) 100%) !important;
        color: #1f2937 !important;
        -webkit-text-fill-color: #1f2937 !important;
        border-color: rgba(161, 113, 13, 0.28) !important;
    }

    body.spb-super-admin-theme .pos-full-page-wrapper .branch-chip {
    ...
    body.spb-super-admin-theme .pos-full-page-wrapper .search-input {
        background: #ffffff !important;
        color: var(--spb-theme-ink) !important;
        -webkit-text-fill-color: var(--spb-theme-ink) !important;
        border-color: rgba(15, 58, 138, 0.18) !important;
    ...
    body.spb-super-admin-theme .pos-full-page-wrapper .search-input::placeholder {
        color: #7b8cab !important;
        -webkit-text-fill-color: #7b8cab !important;
    }

    body.spb-super-admin-theme .pos-full-page-wrapper .search-kbd {
    ...
    body.spb-super-admin-theme .pos-full-page-wrapper .user-avatar {
        background: linear-gradient(135deg, var(--spb-theme-blue) 0%, var(--spb-theme-blue-bright) 100%) !important;
        color: #ffffff !important;
        -webkit-text-fill-color: #ffffff !important;
        border: 2px solid var(--spb-theme-gold) !important;
    }
            ...
            <ul>
                ...
                <li class="submenu {{ Request::is('superadmin*') && !Request::is('superadmin/hotels*') ? 'active subdrop' : '' }}">
                    ...
                    <ul>
                        ...
                        <li class="{{ request()->routeIs('super_admin.business-users.add') ? 'active' : '' }}">
                            <a href="{{ route('super_admin.business-users.add') }}">Add Business Users</a>
                        </li>
                ...
                <li class="submenu {{ Request::is('customers*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-user-group"></i><span>Customers</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ Request::is('suppliers*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-truck-field"></i><span>Suppliers</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li><a href="{{ route('inventory.Products') }}"><i class="fas fa-boxes-stacked"></i><span>Inventory</span></a></li>
                ...
                <li class="submenu {{ Request::is('inventory/serials*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-hashtag"></i><span>Serial Numbers</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ Request::is('inventory/barcodes*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-barcode"></i><span>Barcodes</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ Request::is('price-lists*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-tags"></i><span>Price Lists</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ Request::is('quotations*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-file-signature"></i><span>Quotations</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="{{ Request::is('estimates*') ? 'active' : '' }}">
                    <a href="{{ route('estimates.index') }}"><i class="fas fa-file-invoice-dollar"></i><span>Sales Orders</span></a>
                </li>

                <li class="submenu {{ Request::is('invoices*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-file-invoice"></i><span>Invoices</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li><a href="{{ route('sales.recurring-invoices.index') }}"><i class="fas fa-arrows-rotate"></i><span>Recurring Invoices</span></a></li>
                ...
                <li class="submenu {{ request()->routeIs('purchases.index', 'purchases.create') || Request::is('purchase-orders*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-cart-shopping"></i><span>Purchasing</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ Request::is('purchase-requisitions*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-clipboard-list"></i><span>Purchase Requisitions</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ Request::is('rfq*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-paper-plane"></i><span>RFQ</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ Request::is('grn*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-truck-ramp-box"></i><span>Goods Received Notes</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li><a href="{{ route('landed-costs.index') }}"><i class="fas fa-ship"></i><span>Landed Costs</span></a></li>
                ...
                <li><a href="{{ route('inventory.Products') }}"><i class="fas fa-warehouse"></i><span>Inventory</span></a></li>
                @if(Route::has('inventory.transfer-audit'))
                    <li><a href="{{ route('inventory.transfer-audit') }}"><i class="fas fa-right-left"></i><span>Transfer Audit</span></a></li>
                @endif
                <li><a href="{{ route('inventory.stock-valuation') }}"><i class="fas fa-chart-column"></i><span>Stock Valuation</span></a></li>
                ...
                <li class="submenu {{ Request::is('cheques*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-money-check-dollar"></i><span>Cheque Register</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ Request::is('loans*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-hand-holding-dollar"></i><span>Loans & Overdraft</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                @if(Route::has('finance.approvals.index'))
                    <li><a href="{{ route('finance.approvals.index') }}"><i class="fas fa-square-check"></i><span>Approval Queue</span></a></li>
                @endif
                @if(Route::has('finance.expense-claims.index'))
                    <li><a href="{{ route('finance.expense-claims.index') }}"><i class="fas fa-wallet"></i><span>Expense Claims</span></a></li>
                @endif
                @if(Route::has('finance.collections.index'))
                    <li><a href="{{ route('finance.collections.index') }}"><i class="fas fa-vault"></i><span>Collections Hub</span></a></li>
                @endif
                @if(Route::has('finance.follow-ups.index'))
                    <li><a href="{{ route('finance.follow-ups.index') }}"><i class="fas fa-calendar-check"></i><span>Follow-Ups</span></a></li>
                @endif
                @if(Route::has('finance.budgets.index'))
                    <li><a href="{{ route('finance.budgets.index') }}"><i class="fas fa-bullseye"></i><span>Budgets</span></a></li>
                @endif

                <li class="submenu {{ request()->routeIs('chart-of-accounts', 'bank-reconciliation', 'manual-journal') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-scale-balanced"></i><span>Accounting</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li><a href="{{ route('intercompany.index') }}"><i class="fas fa-building-circle-arrow-right"></i><span>Intercompany</span></a></li>

                <li class="submenu {{ Request::is('cost-centers*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-sitemap"></i><span>Cost Centers</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                @if($canViewTaxation)
                    ...
                    <li class="submenu {{ Request::is('compliance/tax-center*', 'compliance/tax-filings*') ? 'active subdrop' : '' }}">
                        <a href="#"><i class="fas fa-percent"></i><span>Taxation</span><span class="menu-arrow"></span></a>
                        <ul>
                ...
                <li class="submenu {{ Request::is('bom*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-diagram-project"></i><span>Bill of Materials</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ Request::is('manufacturing*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-industry"></i><span>Manufacturing Orders</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="submenu {{ request()->routeIs('employees.*', 'payroll.*', 'salary-structures.*', 'departments.*', 'hr.leave.*', 'hr.attendance.*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-people-group"></i><span>HR Workspace</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                @if(Route::has('finance.fixed-assets.index'))
                    <li><a href="{{ route('finance.fixed-assets.index') }}"><i class="fas fa-building-columns"></i><span>Asset Register</span></a></li>
                @endif
                <li><a href="{{ route('assets.maintenance.index') }}"><i class="fas fa-screwdriver"></i><span>Asset Maintenance</span></a></li>

                <li><a href="{{ route('projects.index') }}"><i class="fas fa-briefcase"></i><span>Project Management</span></a></li>
                <li><a href="{{ route('timesheets.index') }}"><i class="fas fa-clock"></i><span>Timesheets</span></a></li>
                <li><a href="{{ route('milestones.index') }}"><i class="fas fa-flag-checkered"></i><span>Milestone Billing</span></a></li>
                <li class="submenu {{ Request::is('forecasting*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-chart-line"></i><span>Forecasting</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                <li><a href="{{ route('report-schedules.index') }}"><i class="fas fa-calendar-days"></i><span>Scheduled Reports</span></a></li>
                <li><a href="{{ route('reports.financial-ratios') }}"><i class="fas fa-chart-pie"></i><span>Financial Ratios</span></a></li>

                @if(Route::has('activity-log.index'))
                    <li><a href="{{ route('activity-log.index') }}"><i class="fas fa-wave-square"></i><span>Activity Log</span></a></li>
                @endif
                @if(Route::has('close.index'))
                    <li><a href="{{ route('close.index') }}"><i class="fas fa-lock"></i><span>Period Close</span></a></li>
                @endif
                @if(Route::has('audit.index'))
                    <li><a href="{{ route('audit.index') }}"><i class="fas fa-clipboard-check"></i><span>Audit Trail</span></a></li>
                @endif

                <li class="menu-title"><span>Workspace</span></li>

                <li class="submenu {{ Request::is('chat*', 'calendar*', 'inbox*', 'messages*') ? 'active subdrop' : '' }}">
                    <a href="#"><i class="fas fa-grip"></i><span>Applications</span><span class="menu-arrow"></span></a>
                    <ul>
                ...
                @if(Route::has('users.index'))
                    <li><a href="{{ route('users.index') }}"><i class="fas fa-user-gear"></i><span>Users</span></a></li>
                @endif
                ...
                <li><a href="{{ route('roles.index') }}"><i class="fas fa-shield-halved"></i><span>Roles & Permission</span></a></li>

                @if(Route::has('profile'))
                    <li><a href="{{ route('profile') }}"><i class="fas fa-id-badge"></i><span>Profile</span></a></li>
                @endif

                <li><a href="{{ route('settings.index') }}"><i class="fas fa-gear"></i><span>Settings</span></a></li>
