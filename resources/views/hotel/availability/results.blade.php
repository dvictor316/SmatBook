...
<style>
    ...
    .sell-hero h3 { color:#fff; margin:0; font-weight:900; }
    ...
    .sell-room-head:after { content:'AVAILABLE'; position:absolute; right:14px; top:14px; background:#16a34a; color:#fff; border-radius:999px; padding:6px 9px; font-size:11px; font-weight:900; }
