...
<li class="{{ $hotelLinkClass('hotel.rooms.index', 'hotel.rooms.create', 'hotel.rooms.edit', 'hotel.rooms.status') }}"><a href="{{ route('hotel.rooms.index') }}">Rooms</a></li>
...
<li class="{{ request()->routeIs('hotel.service_centers.show') && $hotelServiceCenter === 'bar' ? 'active' : '' }}"><a href="{{ route('hotel.service_centers.show', 'bar') }}">Bar</a></li>
<li class="{{ request()->routeIs('hotel.service_centers.show') && $hotelServiceCenter === 'gym' ? 'active' : '' }}"><a href="{{ route('hotel.service_centers.show', 'gym') }}">Gym</a></li>
<li class="{{ request()->routeIs('hotel.service_centers.show') && $hotelServiceCenter === 'spa' ? 'active' : '' }}"><a href="{{ route('hotel.service_centers.show', 'spa') }}">Spa</a></li>
