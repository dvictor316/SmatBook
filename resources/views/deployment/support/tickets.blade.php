...
@section('page-title', 'Deploymentsupporttickets')

@section('content')
<div class="container-fluid py-4">
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <h4 class="mb-2">Deploymentsupporttickets</h4>
            <p class="text-muted mb-3">This module page is now wired and reachable. Replace content with final business UI as needed.</p>
            <div class="small text-muted">View file: <code>deployment/support/tickets.blade.php</code></div>
            <div class="mt-3">
