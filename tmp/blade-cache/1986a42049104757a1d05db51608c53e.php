                ...
                <div class="row align-items-center inventory-page-header">
                    ...
                    <div class="col-md-8 text-end">
                        <div class="inventory-toolbar">
                            <form method="GET" action="<?php echo e(route('product-list')); ?>" class="d-flex inventory-search-form">
                                <div class="input-group">
                                    <input type="text" name="search" value="<?php echo e($search ?? ''); ?>" class="form-control" placeholder="Search SKU or Name...">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="<?php echo e(route('inventory.Products.import.template')); ?>"><i class="far fa-file-lines me-2 text-primary"></i>Download Spreadsheet Template</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge <?php echo e($displayStock <= 5 ? 'bg-danger' : 'bg-success'); ?>">
                                                <?php echo e(rtrim(rtrim(number_format($displayStock, 2), '0'), '.')); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="from_branch_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = ($availableBranches ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="modal fade" id="addProductModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('inventory.Products.store')); ?>" enctype="multipart/form-data" id="quick_add_product_form">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/Users/victor/Desktop/smat-book/resources/views/Inventory/Products/index.blade.php ENDPATH**/ ?>